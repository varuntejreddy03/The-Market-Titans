...
const SocialProof = () => (
  <section style={{ background: '#0D1B2E' }} className="relative z-20 overflow-hidden">
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map(({ value, suffix, label, sub }) => (
          ...
          >
            <div className="font-display leading-none tracking-tight mb-3 stat-number" style={{ color: '#F5A623', fontSize: '40px', fontWeight: 800 }}>
              {value}<span style={{ fontSize: '20px' }}>{suffix}</span>
            </div>
